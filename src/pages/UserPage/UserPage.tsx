          ...
          {!orders?.length ? (
            <div className={style.userPage__dontHaveOrders}>
              <div className={style.userPage__smileBlock}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className={style.userPage__smile}
                  viewBox="0 0 256 256"
                >
                  ...
                  <circle
                    ...
                    r="96"
                    fill="none"
                    className={style.userPage__stroke}
                    strokeLinecap="round"
              ...
              <p className={style.userPage__noOrdersText}>
            ...
            <div className={style.userPage__ordersBlock}>
              {orders?.map((order) => {
                const orderData = new Date(order.createdAt)
                  .toString()
                  .split(' ')
                  .splice(0, 5)
                  .join(' ');
                    ...
                    <div className={style.userPage__ordersDate}>
                      {order.products.map((productItem) => (
                        ...
                        >
                          ...
                          />
                          <div>
                            <h3 className={style.userPage__productItem_title}>
                              {productItem.title}
                            </h3>
                            <p
                              className={style.userPage__productItem_price}
                            >{`${productItem.price}$`}</p>
                          </div>
                        </div>
                      ))}
